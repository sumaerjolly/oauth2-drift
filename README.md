...
```php
$provider = new SumaerJolly\OAuth2\Client\Provider\Drift([
    'clientId'          => '{drift-app-id}',
    'clientSecret'      => '{drift-app-secret}',
...
At the time of authoring this documentation, the [following scopes are available](https://devdocs.drift.com/docs/authentication-and-scopes).
